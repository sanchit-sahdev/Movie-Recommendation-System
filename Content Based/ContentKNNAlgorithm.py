...
class ContentKNNAlgorithm(AlgoBase):
    ...
    def fit(self, trainset):
        ...
        for thisRating in range(self.trainset.n_items):
            """"if (thisRating % 100 == 0):"""
            print(thisRating, " of ", self.trainset.n_items, "\t\t", "#"+str(random.randint(0,10000)))
 ...
 #----------------- Cosine Similarity Formual (Used for Genres) ---------------------#  
...
#-------------------------------------------------------------------------------------#
    ...
    def editedCosineSim(self, movie1, movie2, genres):
        genres1 = genres[movie1]
        genres2 = genres[movie2]
